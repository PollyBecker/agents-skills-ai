...
- Arquitetura: **Clean Architecture** com Factory como dona das regras de negocio.
...
backend/
  ...
  factories/                     # Criacao de objetos + regras de negocio
    [dominio]_factory.py
  mappers/                       # Model <-> Response (so conversao)
    [dominio]_mapper.py
...
1. Service e Router sao camadas opacas — nunca conhecem campos do DTO
2. Factory cria objetos e contem regras de negocio (validacoes, invariantes)
3. Mapper so converte entre camadas — nunca valida
4. UI e a fabrica de DTOs - ela cria, ela conhece os campos
5. Mock antes de backend - cliente valida o fluxo antes do codigo real
6. VITE_USE_MOCK - flag obrigatoria em todo projeto
7. tenant_id em TODA tabela e TODA query - sem excecao
8. BI nunca em banco relacional - sempre Gold layer do datalake
9. Arquiteto SQL so age apos DTOs completos - banco segue os DTOs
10. Playwright so apos QA 11+12+13 - nao pular etapas
11. Dev Front e Dev Back sao times separados - coordenados pelo P.O.
12. Duvidas em aberto sao valiosas - nunca resolver com suposicoes
13. Imports explicitos, sem barrel exports (__init__.py)
14. Backend SEM pasta app/ — tudo na raiz de backend/
